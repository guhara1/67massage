  ...
  <div class="wrap nav">
    ...
    <nav aria-label="주 메뉴"><ul class="menu">
      <li><a href="{root}services.html">서비스 안내 <i class="caret"></i></a>
        <div class="dropdown">
          <a href="{root}services.html#swedish">스웨디시 <span>전신 순환·이완 관리</span></a>
...
<aside class="drawer" id="drawer" aria-label="모바일 메뉴">
  ...
  <details><summary>서비스 안내 <i class="caret"></i></summary><div class="sub-links">
    <a href="{root}services.html#swedish">스웨디시</a><a href="{root}services.html#aroma">아로마 테라피</a>
...
def footer(root):
  ...
  <div class="footer-top">
    ...
    <div><h5>서비스</h5><ul class="fl">
      ...
      <li><a href="{root}services.html#deep">딥티슈</a></li><li><a href="{root}services.html#sports">스포츠 회복</a></li></ul></div>
    <div><h5>바로가기</h5><ul class="fl">
      <li><a href="{root}areas.html">출장지역</a></li><li><a href="{root}magazine/index.html">매거진</a></li>
      <li><a href="{root}about.html">회사소개</a></li><li><a href="{root}guide.html">이용안내</a></li></ul></div>
  </div>
  <div class="biz">
    <b>상호</b> 67 마사지 &nbsp;|&nbsp; <b>회사</b> YH LAB &nbsp;|&nbsp; <b>대표</b> 김유환 &nbsp;|&nbsp; <b>사업자등록번호</b> 815-26-00585<br>
    <b>주소</b> 경기도 파주시 청석로 268 &nbsp;|&nbsp; <b>전화예약</b> <a href="tel:0508-202-4717" style="color:var(--gold-hi)">0508-202-4717</a><br>
